    ...
    <div class="hs-footer-container">
        ...
        <div class="hs-footer-main">
            ...
            <div class="hs-footer-col hs-instagram-col">
                ...
                <div class="elfsight-app-449284d1-d724-47a3-8668-c580fcba5d3c" data-elfsight-app-lazy></div>
                <!-- <div>
                        <p>hello world</p>
                     </div> -->
            </div>
...
const observer = new MutationObserver((mutations) => {
    // Look for the specific link using a unique part of its style string
    const targetLink = document.querySelector('a[style*="background-color:rgba(238, 238, 238, 0.9)"]');

    if (targetLink) {
        // 1. Wipe the messy inline styles
        targetLink.removeAttribute('style');

        // 2. Apply your specific color and essential layout
        ...
        // observer.disconnect(); // Keep this commented out if the link flickers back
    }
});
...
/* This targets the link once the JS has stripped the inline style attribute */
a[target="_blank"][rel="noreferrer"] {
    color: #ffffff !important;
    background-color: transparent !important;
    /* Ensures the grey is gone */
    text-decoration: underline;
    /* Optional: adds a link underline */
    display: none !important;
    /* Hides the link completely */
}
